...
public class SimpleSessionPortlet extends GenericPortlet {
   ...
   protected void doView(RenderRequest renderRequest, RenderResponse renderResponse)
      ...
      String visitCount = (String) session.getAttribute("timesvisited", PortletSession.APPLICATION_SCOPE);

      if (visitCount == null) {
         // If this is the first time viewing the portlet,
         // set the timevisited value to 1
         session.setAttribute("timesvisited", "1", PortletSession.APPLICATION_SCOPE);
         ...
         session.setAttribute("timesvisited", "" + newCount, PortletSession.APPLICATION_SCOPE);
